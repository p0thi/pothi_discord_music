...
public class Decode {
  ...
  int synth1to1mono(final MPGLib.mpstr_tag mp, final float[] bandPtr,
                    final int bandPos, final float[] out, final MPGLib.ProcessedBytes pnt) {
    float[] samples = new float[64];

    int clip = synth_1to1(mp, bandPtr, bandPos, 0, samples,
        new MPGLib.ProcessedBytes());
  ...
  void synth1to1monoUnclipped(final MPGLib.mpstr_tag mp, final float[] bandPtr,
                              final int bandPos, final float[] out, final MPGLib.ProcessedBytes pnt) {
    float[] samples = new float[64];
  ...
  int synth_1to1(MPGLib.mpstr_tag mp, float[] bandPtr, int bandPos, int ch,
                 float[] out, MPGLib.ProcessedBytes pnt) {
    float[] b0;
    int clip = 0;
    int bo1;
  ...
  void synth_1to1_unclipped(MPGLib.mpstr_tag mp, float[] bandPtr, int bandPos,
                            int ch, float[] out, MPGLib.ProcessedBytes pnt) {
    float[] b0;
    int bo1;
