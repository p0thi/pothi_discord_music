...
public class Common {
  ...
  public final int getbits(final MPGLib.mpstr_tag mp, final int number_of_bits) {
    long rval;
  ...
  public final int getbits_fast(final MPGLib.mpstr_tag mp, final int number_of_bits) {
    long rval;
  ...
  public final int set_pointer(final MPGLib.mpstr_tag mp, final int backstep) {
