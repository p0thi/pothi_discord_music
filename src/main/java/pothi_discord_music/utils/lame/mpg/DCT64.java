...
public class DCT64 {
  ...
  public void dct64_1(float[] out0, int out0Pos, float[] out1, int out1Pos,
                      float[] b1, int b2, float[] samples, int samplesPos, float[] pnts[]) {

    {
      float[] costab = pnts[0];

      b1[0x00] = samples[samplesPos + 0x00] + samples[samplesPos + 0x1F];
      b1[0x1F] = (samples[samplesPos + 0x00] - samples[samplesPos + 0x1F])
          * costab[0x0];

      b1[0x01] = samples[samplesPos + 0x01] + samples[samplesPos + 0x1E];
      b1[0x1E] = (samples[samplesPos + 0x01] - samples[samplesPos + 0x1E])
          * costab[0x1];

      b1[0x02] = samples[samplesPos + 0x02] + samples[samplesPos + 0x1D];
      b1[0x1D] = (samples[samplesPos + 0x02] - samples[samplesPos + 0x1D])
          * costab[0x2];

      b1[0x03] = samples[samplesPos + 0x03] + samples[samplesPos + 0x1C];
      b1[0x1C] = (samples[samplesPos + 0x03] - samples[samplesPos + 0x1C])
          * costab[0x3];

      b1[0x04] = samples[samplesPos + 0x04] + samples[samplesPos + 0x1B];
      b1[0x1B] = (samples[samplesPos + 0x04] - samples[samplesPos + 0x1B])
          * costab[0x4];

      b1[0x05] = samples[samplesPos + 0x05] + samples[samplesPos + 0x1A];
      b1[0x1A] = (samples[samplesPos + 0x05] - samples[samplesPos + 0x1A])
          * costab[0x5];

      b1[0x06] = samples[samplesPos + 0x06] + samples[samplesPos + 0x19];
      b1[0x19] = (samples[samplesPos + 0x06] - samples[samplesPos + 0x19])
          * costab[0x6];

      b1[0x07] = samples[samplesPos + 0x07] + samples[samplesPos + 0x18];
      b1[0x18] = (samples[samplesPos + 0x07] - samples[samplesPos + 0x18])
          * costab[0x7];

      b1[0x08] = samples[samplesPos + 0x08] + samples[samplesPos + 0x17];
      b1[0x17] = (samples[samplesPos + 0x08] - samples[samplesPos + 0x17])
          * costab[0x8];

      b1[0x09] = samples[samplesPos + 0x09] + samples[samplesPos + 0x16];
      b1[0x16] = (samples[samplesPos + 0x09] - samples[samplesPos + 0x16])
          * costab[0x9];

      b1[0x0A] = samples[samplesPos + 0x0A] + samples[samplesPos + 0x15];
      b1[0x15] = (samples[samplesPos + 0x0A] - samples[samplesPos + 0x15])
          * costab[0xA];

      b1[0x0B] = samples[samplesPos + 0x0B] + samples[samplesPos + 0x14];
      b1[0x14] = (samples[samplesPos + 0x0B] - samples[samplesPos + 0x14])
          * costab[0xB];

      b1[0x0C] = samples[samplesPos + 0x0C] + samples[samplesPos + 0x13];
      b1[0x13] = (samples[samplesPos + 0x0C] - samples[samplesPos + 0x13])
          * costab[0xC];

      b1[0x0D] = samples[samplesPos + 0x0D] + samples[samplesPos + 0x12];
      b1[0x12] = (samples[samplesPos + 0x0D] - samples[samplesPos + 0x12])
          * costab[0xD];

      b1[0x0E] = samples[samplesPos + 0x0E] + samples[samplesPos + 0x11];
      b1[0x11] = (samples[samplesPos + 0x0E] - samples[samplesPos + 0x11])
          * costab[0xE];

      b1[0x0F] = samples[samplesPos + 0x0F] + samples[samplesPos + 0x10];
      b1[0x10] = (samples[samplesPos + 0x0F] - samples[samplesPos + 0x10])
          * costab[0xF];
    }
    ...
    {
      final float cos0 = pnts[3][0];
      final float cos1 = pnts[3][1];
